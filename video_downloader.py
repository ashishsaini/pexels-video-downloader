...
class VideoDownloader:
    ...
    def _run(self, id):
        ...
        selected_video = self._select_video_type(video_data, self.resolution_width)
    ...
    def search_video(self, query):
        ...
        for i in range(0,9):
            ...
            selected_video = self._select_video_type(search_result['videos'][index], self.resolution_width)
            if selected_video:
