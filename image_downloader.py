...
class ImageDownloader:
    ...
    def get_image(self, keyword):
        ...
        print(f""+search_result['photos'][index]["src"]["original"]+"?auto=compress&cs=tinysrgb&fit=crop&h="+str(self.resolution_height)+"&w="+str(self.resolution_width))
        exit()
...
if __name__ == "__main__":
    ...
    # search image
    pexels_d = ImageDownloader('logs/pexels_downloader.log')
    pexels_d.resolution_width = 1280
    pexels_d.resolution_height = 720
    result = pexels_d.get_image("black")
    print(result)